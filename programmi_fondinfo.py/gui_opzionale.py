...
class BubbleBobbleGui:
    ...
    def tick(self):
        ...
        if LIV == 0:
            g2d.set_color((0,20,20))
            g2d.fill_rect((0,0,512,424))
            inizio = "schiaccia b per avviare la partita"
            g2d.set_color((200,200,0))
            g2d.draw_text(inizio, (150, 34), 15)
            g2d.draw_image_clip(self._skins, (0,1440,190,150), (150,150,200,200))
        elif LIV == 1:
